...
enum class TokenType {
    ...
    THROW(KEYWORDS), MODULE(KEYWORDS), INCLUDE(KEYWORDS), FROM(KEYWORDS),
    ENUM(KEYWORDS), USE(KEYWORDS),
    ...
    TYPE_FLOAT(TYPES), TYPE_DOUBLE(TYPES), TYPE_TUPLE(TYPES),
