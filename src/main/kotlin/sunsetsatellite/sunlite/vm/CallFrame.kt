...
class CallFrame(val closure: SLClosure, val locals: MutableList<AnySLValue>) {
    ...
    override fun toString(): String {
        ...
        return "${if (name == "") "<script>" else name} in ${if(file != null) file else if(closure.function.modifier.contains(FunctionModifier.NATIVE)) "<native fn>" else "<unknown file>"}:${line}"
