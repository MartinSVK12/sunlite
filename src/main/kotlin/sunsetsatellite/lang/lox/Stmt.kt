...
abstract class Stmt {
	...
	data class Var(val name: Token, val type: Type, val initializer: Expr?, val modifier: FieldModifier) : Stmt(), NamedStmt {
		override fun <R> accept(visitor: Visitor<R>): R {
	...
	data class Function(val name: Token, val params: List<Param>, val body: List<Stmt>, var modifier: FunctionModifier, val returnType: Type, val typeParams: List<Param>) : Stmt(), NamedStmt{
		override fun <R> accept(visitor: Visitor<R>): R {
	...
	data class Class(val name: Token, val methods: List<Function>, val fieldDefaults: List<Var>, val superclass: Expr.Variable?, val superinterfaces: List<Expr.Variable>, val modifier: ClassModifier, val typeParameters: List<Param>) : Stmt(), NamedStmt{
		override fun <R> accept(visitor: Visitor<R>): R {
	...
	data class Interface(val name: Token, val methods: List<Function>, val superinterfaces: List<Expr.Variable>, val typeParameters: List<Param>) : Stmt(), NamedStmt{
		override fun <R> accept(visitor: Visitor<R>): R {
